...
import { Box, useTheme as useTheme$1 } from '@mui/system';
import AppBar from '@mui/material/AppBar';
import Typography from '@mui/material/Typography';
import Box$1 from '@mui/material/Box';
import { useTheme, alpha, createTheme, ThemeProvider, styled } from '@mui/material/styles';
...
var main = function main() {
  ...
  return ReactDOM.render(React__default.createElement(ZestyExplorer, null), document.getElementById("zesty-explorer"));
};
